...
To summarize, we find relatively high correlation coefficients for the factors T, Td, CAPE and FH of which we know from theory to have an influence on precipitation changes. These correlations are stronger for the extremes in these variables. Different forms of relationships (linear, exponential, combination of both) are recognized by point clouds. 2-day T and Td maxima relate in a semi-expontential form to precipitation maxima. CAPE and FH 2-day maxima have a distinctive exponential relationship with precipitation maxima. With respect to 2-day P, the Pearson correlations are higher for T and Td 2-day maxima (cor=0.33 and 0.36 respectively),than the Spearman correlations. This approach considers the strenght of linear relationships. The Spearman correlations describe non-linear relationships and are much higher and the highest of all explanatory variables for 2-day maxima in P corresponds to the 2-day maxima in FH (cor=0.4). Despite of the exponential dependancy between 2-day CAPE and precipitation maxima, corresponding Spearman correlations are lower than the Pearson correlations. Following 2-day maxima FH, the order of strength regarding the Spearman correlation with 2-day maxima in P (of which significant trends are found in Chapter 3 REF) is: TD (cor=0.3), T (cor=0.2), and lastly CAPE (cor=0.07).
...
In order to investigate this, and also for the trends in the 2-day maxima of the other variables, we conduct a 9999 Monte Carlo permutation test. Table \ref{tab:p_rates_all} gives an overview of the significance of the trends. A red (green) marking of a cell indicates a negative (positive) trend significant at the 95\% confidence level. All the linear and quantile regression trends are significant, except for the 99\%-quantile of 2-day maxima in FH (p=0.94), of which we already discusses the large uncertainty expressed by the wide confidence interval for this quantile. In fact, all the trends are significant on the 99\% confidencence level, except for the 99\%-quantile for FH and CAPE. It should be stressed that the 2-day maxima in CAPE are based only on data of De Bilt and for the period 1993-2015. Due to this different temporal lenght of the data set the resolution is 60\% lower than for the 2-day maximain T, TD and FH. Nontheless, the 99\%-quantile trend for this variable is significant on the 95\% confidence level and the other quantile trends on the 99\% confidence level.
