...
p_SW <- p_test(data=QRS_max2d,tau=0.50)
setnames(p_SW,c("STN","Q50s"))
p_SW[, ":="(Q75s = p_test(data=max2dS,tau=0.75)$V1, Q90s = p_test(data=max2dS,tau=0.90)$V1)]
p_SW[, ":="(Q95s = p_test(data=max2dS,tau=0.95)$V1, Q99s = p_test(data=max2dS,tau=0.99)$V1,
...
p_SW[, ":="(Q50w = p_test(data=max2dW,tau=0.50)$V1,Q75w = p_test(data=max2dW,tau=0.75)$V1,
         Q90w = p_test(data=max2dW,tau=0.90)$V1)]
p_SW[, ":="(Q95w = p_test(data=max2dW,tau=0.95)$V1, Q99w = p_test(data=max2dW,tau=0.99)$V1,
         Q999w = p_test(data=max2dW,tau=0.999)$V1)]
@

<<cache=TRUE>>=
save(p_SW, file="./inst/tussenStap/p_SW.rda")
@

<<cache=FALSE>>=
load("./inst/tussenStap/p_SW.rda")
@
...
ggplot(yearlyMax, aes(x = Year, y = RHmax)) + geom_point() +
  ...
  facet_wrap(~STN) +
  xlab("Year") + ylab("Annual max mm/hr")
@
...
p_freq <- p_test(data=QR_freq,tau=0.50,freq=TRUE)
setnames(p_freq,c("STN","Q50"))
p_freq[, ":="(Q75 = p_test(data=QR_freq,tau=0.75,freq=TRUE)$V1, Q90 = p_test(data=QR_freq,tau=0.90,freq=TRUE)$V1)]
p_freq[, ":="(Q95 = p_test(data=QR_freq,tau=0.95,freq=TRUE)$V1, Q99 = p_test(data=QR_freq,tau=0.99,freq=TRUE)$V1,
         Q999 = p_test(data=QR_freq,tau=0.999,freq=TRUE)$V1)]
@

<<p_test_freqS,cache=TRUE>>=
p_freq[, ":="(Q50s = p_test(data=QR_Sfreq,tau=0.50,freq=TRUE)$V1,
         Q75s = p_test(data=QR_Sfreq,tau=0.75,freq=TRUE)$V1,
         Q90s = p_test(data=QR_Sfreq,tau=0.90,freq=TRUE)$V1)]
p_freq[, ":="(Q95s = p_test(data=QR_Sfreq,tau=0.95,freq=TRUE)$V1,
         Q99s = p_test(data=QR_Sfreq,tau=0.99,freq=TRUE)$V1,
         Q999s = p_test(data=QR_Sfreq,tau=0.999,freq=TRUE)$V1)]
@

<<p_test_freqW,cache=TRUE>>=
p_freq[, ":="(Q50w = p_test(data=QR_Wfreq,tau=0.50,freq=TRUE)$V1,
         Q75w = p_test(data=QR_Wfreq,tau=0.75,freq=TRUE)$V1,
         Q90w = p_test(data=QR_Wfreq,tau=0.90,freq=TRUE)$V1)]
p_freq[, ":="(Q95w = p_test(data=QR_Wfreq,tau=0.95,freq=TRUE)$V1,
