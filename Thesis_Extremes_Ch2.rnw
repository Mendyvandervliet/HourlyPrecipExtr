...
ggplot(freq_5, aes(x = Year,y = f)) +        # data
    ...
    geom_curve(aes(x=1968,xend= 1968+30,y=50, yend=50), curvature=0.4, color="red",linetype=2)+
    geom_curve(aes(x=1998,xend= 1998+17,y=50, yend=50), curvature=-0.5, color="red",linetype=2)+
