...
Figure \ref{fig:QuantileTrends} shows the trend in the 25, 50, 75 and 90 percentile of annual maximum hourly rainfall.
...
save(freq_Wwet, file="./inst/tussenStap/QR_Wfreq.rda")
@
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    \flushleft
<<label=QR_max2d,cache=TRUE>>=
plot1 <- QR2d_plotting(data=QR_freq[STN == 235], title="De Kooy")
plot2 <- QR2d_plotting(data=QR_freq[STN == 260], title="De Bilt")
plot3 <- QR2d_plotting(data=QR_freq[STN == 280], title="Eelde")
plot4 <- QR2d_plotting(data=QR_freq[STN == 310], title="Vlissingen")
plot5 <- QR2d_plotting(data=QR_freq[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  ...
  \begin{minipage}{0.48\textwidth}
    \flushleft
<<label=QRW_max2d>>=
plot1 <- QR2d_plotting(data=QR_Wfreq[STN == 235], title="De Kooy",point=FALSE)
plot2 <- QR2d_plotting(data=QR_Wfreq[STN == 260], title="De Bilt",point=FALSE)
plot3 <- QR2d_plotting(data=QR_Wfreq[STN == 280], title="Eelde",point=FALSE)
plot4 <- QR2d_plotting(data=QR_Wfreq[STN == 310], title="Vlissingen",point=FALSE)
plot5 <- QR2d_plotting(data=QR_Wfreq[STN == 380], title="Maastricht",point=FALSE)
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  \subcaption{Winter}
  ...
  \hspace{-0.5cm}
    ...
    \flushleft
<<label=QRS_max2d>>=
plot1 <- QR2d_plotting(data=QR_Sfreq[STN == 235], title="De Kooy",point=FALSE)
plot2 <- QR2d_plotting(data=QR_Sfreq[STN == 260], title="De Bilt",point=FALSE)
plot3 <- QR2d_plotting(data=QR_Sfreq[STN == 280], title="Eelde",point=FALSE)
plot4 <- QR2d_plotting(data=QR_Sfreq[STN == 310], title="Vlissingen",point=FALSE)
plot5 <- QR2d_plotting(data=QR_Sfreq[STN == 380], title="Maastricht",point=FALSE)
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  \subcaption{Summer}
