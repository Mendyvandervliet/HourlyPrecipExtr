...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    \centering
<<label=K_autocor,cache=TRUE,out.width='250px',fig.height=4,fig.width=5>>=
acf(hrKNMI[STN==235]$RH,lag.max=80,main=NA)
  ...
  \begin{minipage}{0.48\textwidth}
    \centering
<<label=B_autocor,cache=TRUE,out.width='250px',fig.height=4,fig.width=5>>=
acf(hrKNMI[STN==260]$RH,lag.max=80,main=NA)
  ...
  \begin{minipage}{0.48\textwidth}
    \centering
<<label=E_autocor,cache=TRUE,out.width='250px',fig.height=4,fig.width=5>>=
acf(hrKNMI[STN==280]$RH,lag.max=80,main=NA)
  ...
  \hfill
   \begin{minipage}{0.48\textwidth}
    \centering
<<label=V_autocor,cache=TRUE,out.width='250px',fig.height=4,fig.width=5>>=
acf(hrKNMI[STN==310]$RH,lag.max=80,main=NA)
  ...
  \hfill
   \begin{minipage}{0.48\textwidth}
    \centering
<<label=M_autocor,cache=TRUE,out.width='250px',fig.height=4,fig.width=5>>=
