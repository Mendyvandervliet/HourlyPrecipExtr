...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    ...
    \flushleft
<<label=QRW_max2d>>=
plot1 <- QR2d_plotting(data=QRW_max2d[STN == 235], title="De Kooy")
plot2 <- QR2d_plotting(data=QRW_max2d[STN == 260], title="De Bilt")
plot3 <- QR2d_plotting(data=QRW_max2d[STN == 280], title="Eelde")
plot4 <- QR2d_plotting(data=QRW_max2d[STN == 310], title="Vlissingen")
plot5 <- QR2d_plotting(data=QRW_max2d[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  \subcaption{Winter}
  ...
  \hspace{-0.5cm}
    ...
    \flushleft
<<label=QRS_max2d>>=
plot1 <- QR2d_plotting(data=QRS_max2d[STN == 235], title="De Kooy")
plot2 <- QR2d_plotting(data=QRS_max2d[STN == 260], title="De Bilt")
plot3 <- QR2d_plotting(data=QRS_max2d[STN == 280], title="Eelde")
plot4 <- QR2d_plotting(data=QRS_max2d[STN == 310], title="Vlissingen")
plot5 <- QR2d_plotting(data=QRS_max2d[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  \subcaption{Summer}
