...
<<legend, cache=TRUE>>=
Legendgrob1 <- legendGrob(c("50%","75%", "90%","95%","99%","99.9%"), pch=15,
...
plot1 <- QR2d_plotting(data=QR_max2d[STN == 235], title="De Kooy")
plot2 <- QR2d_plotting(data=QR_max2d[STN == 260], title="De Bilt")
plot3 <- QR2d_plotting(data=QR_max2d[STN == 280], title="Eelde")
plot4 <- QR2d_plotting(data=QR_max2d[STN == 310], title="Vlissingen")
plot5 <- QR2d_plotting(data=QR_max2d[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob1, ncol=2),
             ncol= 1)
@
...
p[, ":="(Q75 = p_test(data=max2d,tau=0.75)$V1, Q90 = p_test(data=max2d,tau=0.90)$V1)]
p[, ":="(Q95 = p_test(data=max2d,tau=0.95)$V1, Q99 = p_test(data=max2d,tau=0.99)$V1,
...
\begin{table}[h!]
  ...
  \hline\hline
    ...
    \hline
    De Kooy   & 235 & 0.13                 & 0.06                   & \cellcolor{green} 0.97 & \cellcolor{green} 1.00 & 0.84                   & 0.16 \\
    De Bilt   & 260 & \cellcolor{red} 0.05 & \cellcolor{green} 0.99 & \cellcolor{green} 1.00 &                   0.93 & 0.92                   & 0.87 \\
    Eelde     & 280 & \cellcolor{red} 0.01 & \cellcolor{green} 0.96 &                   0.92 &                   0.91 & 0.77                   & 0.33 \\
    Vlissingen& 310 & 0.92                 &                   0.07 &                   0.27 & \cellcolor{green} 0.96 & 0.81 & 0.38 \\
    Maastricht& 380 & 0.16                 &                   0.13 & \cellcolor{green} 0.98 & 0.94                   & 0.49 & 0.67 \\
     \hline
  \end{tabular}
\end{table}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    ...
    \flushleft
<<label=QRW_max2d>>=
plot1 <- QR2d_plotting(data=QRW_max2d[STN == 235], title="De Kooy",point=FALSE)
plot2 <- QR2d_plotting(data=QRW_max2d[STN == 260], title="De Bilt",point=FALSE)
plot3 <- QR2d_plotting(data=QRW_max2d[STN == 280], title="Eelde",point=FALSE)
plot4 <- QR2d_plotting(data=QRW_max2d[STN == 310], title="Vlissingen",point=FALSE)
plot5 <- QR2d_plotting(data=QRW_max2d[STN == 380], title="Maastricht",point=FALSE)
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob1, ncol=2),
             ncol= 1)
@
  \subcaption{Winter}
  ...
  \hspace{-0.5cm}
    ...
    \flushleft
<<label=QRS_max2d>>=
plot1 <- QR2d_plotting(data=QRS_max2d[STN == 235], title="De Kooy",point=FALSE)
plot2 <- QR2d_plotting(data=QRS_max2d[STN == 260], title="De Bilt",point=FALSE)
plot3 <- QR2d_plotting(data=QRS_max2d[STN == 280], title="Eelde",point=FALSE)
plot4 <- QR2d_plotting(data=QRS_max2d[STN == 310], title="Vlissingen",point=FALSE)
plot5 <- QR2d_plotting(data=QRS_max2d[STN == 380], title="Maastricht",point=FALSE)
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob1, ncol=2),
             ncol= 1)
@
  \subcaption{Summer}
...
p <- p_test(data=QRS_max2d,tau=0.50)
setnames(p,c("STN","Q50s"))
p[, ":="(Q75s = p_test(data=max2dS,tau=0.75)$V1, Q90s = p_test(data=max2dS,tau=0.90)$V1)]
p[, ":="(Q95s = p_test(data=max2dS,tau=0.95)$V1, Q99s = p_test(data=max2dS,tau=0.99)$V1,
...
p[, ":="(Q50w = p_test(data=max2dW,tau=0.50)$V1,Q75w = p_test(data=max2dW,tau=0.75)$V1,
         Q90w = p_test(data=max2dW,tau=0.90)$V1)]
p[, ":="(Q95w = p_test(data=max2dW,tau=0.95)$V1, Q99w = p_test(data=max2dW,tau=0.99)$V1,
         Q999w = p_test(data=max2dW,tau=0.999)$V1)]
@

<<>>=
save(p, file="./inst/tussenStap/p_SW.rda")
@

<<p_SWtbl>>=
# setnames(p, c("Station","50%","75%","90%","95","99%","99.9%","50%","75%","90%","95","99%","99.9%"))
# tbl <- xtable(p)
# print(tbl,
#     only.contents=TRUE,
...
%-------------------------
\paragraph{Yearly maximum}\par\medskip
...
<<AggregateByYear>>=
yearlyMax <- hrKNMI[, list(RHmax = max(RH)), by = list(STN, Year)]
...
ggplot(yearlyMax, aes(x = Year, y = RHmax)) + geom_point() +
  ...
  geom_quantile(formula = y ~ x,quantiles=0.90) +
  facet_wrap(~STN) +
  xlab("") + ylab("Annual max mm/hr")
@
  \caption{The 25, 50, 75 and 90 percentile of annual maximum hourly rainfall for every station}
  \label{fig:Yearlymax}
\end{figure}

Figure \ref{fig:Yearlymax} shows the trend in the 25, 50, 75 and 90 percentile of annual maximum hourly rainfall.
...
Legendgrob2 <- legendGrob(c("25%","50%","75%", "90%"), pch=15,
                          gp=gpar(col=c("black","blue","green","orange"),cex=1), ncol=2)
...
plot1 <- QR_freqplotting(data=QR_freq[STN == 235], title="De Kooy")
plot2 <- QR_freqplotting(data=QR_freq[STN == 260], title="De Bilt")
plot3 <- QR_freqplotting(data=QR_freq[STN == 280], title="Eelde")
plot4 <- QR_freqplotting(data=QR_freq[STN == 310], title="Vlissingen")
plot5 <- QR_freqplotting(data=QR_freq[STN == 380], title="Maastricht")
...
@
    \subcaption{Impact $>$ 10 mm/hr}
    \label{fig:impact}
  \end{minipage}
  \caption{Quantile regression fits with $\tau = 25, 50, 75, 90$ \% on counts of wet hours a year, for all hours (a) and .., for all stations.}
  \label{fig:QR_freq}
\end{figure}
\hfill
\begin{figure}[H]
...
plot1 <- QR_freqplotting(data=QR_Wfreq[STN == 235], title="De Kooy")
plot2 <- QR_freqplotting(data=QR_Wfreq[STN == 260], title="De Bilt")
plot3 <- QR_freqplotting(data=QR_Wfreq[STN == 280], title="Eelde")
plot4 <- QR_freqplotting(data=QR_Wfreq[STN == 310], title="Vlissingen")
plot5 <- QR_freqplotting(data=QR_Wfreq[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  \subcaption{Winter}
...
plot1 <- QR_freqplotting(data=QR_Sfreq[STN == 235], title="De Kooy")
plot2 <- QR_freqplotting(data=QR_Sfreq[STN == 260], title="De Bilt")
plot3 <- QR_freqplotting(data=QR_Sfreq[STN == 280], title="Eelde")
plot4 <- QR_freqplotting(data=QR_Sfreq[STN == 310], title="Vlissingen")
plot5 <- QR_freqplotting(data=QR_Sfreq[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
    \subcaption{Summer}
    \label{fig:Qfreq_sum}
  \end{minipage}
  \caption{Quantile regression fits with $\tau = 25, 50, 75, 90$ \% on counts of wet hours a year, for only Winter (a) and only Summer (b) data, for all stations.}
  \label{fig:QR_freqWS}
\end{figure}
...
p <- p_test(data=QR_freq,tau=0.50,freq==TRUE)
setnames(p,c("STN","Q50"))
p[, ":="(Q75 = p_test(data=QR_freq,tau=0.75,freq==TRUE)$V1, Q90 = p_test(data=QR_freq,tau=0.90,freq==TRUE)$V1)]
p[, ":="(Q95 = p_test(data=QR_freq,tau=0.95,freq==TRUE)$V1, Q99 = p_test(data=QR_freq,tau=0.99,freq==TRUE)$V1,
         Q999 = p_test(data=QR_freq,tau=0.999,freq==TRUE)$V1)]
@

<<p_test_freqS,cache=TRUE>>=
p[, ":="(Q50s = p_test(data=QR_Sfreq,tau=0.50,freq==TRUE)$V1,
         Q75s = p_test(data=QR_Sfreq,tau=0.75,freq==TRUE)$V1,
         Q90s = p_test(data=QR_Sfreq,tau=0.90,freq==TRUE)$V1)]
p[, ":="(Q95s = p_test(data=QR_Sfreq,tau=0.95,freq==TRUE)$V1,
         Q99s = p_test(data=QR_Sfreq,tau=0.99,freq==TRUE)$V1,
         Q999s = p_test(data=QR_Sfreq,tau=0.999,freq==TRUE)$V1)]
@

<<p_test_freqW,cache=TRUE>>=
p[, ":="(Q50w = p_test(data=QR_Wfreq,tau=0.50,freq==TRUE)$V1,
         Q75w = p_test(data=QR_Wfreq,tau=0.75,freq==TRUE)$V1,
         Q90w = p_test(data=QR_Wfreq,tau=0.90,freq==TRUE)$V1)]
p[, ":="(Q95w = p_test(data=QR_Wfreq,tau=0.95,freq==TRUE)$V1,
         Q99w = p_test(data=QR_Wfreq,tau=0.99,freq==TRUE)$V1,
         Q999w = p_test(data=QR_Wfreq,tau=0.999,freq==TRUE)$V1)]
save(p, file="./inst/tussenStap/p_freq.rda")
@
...
<<p_freqtbl>>=
# setnames(p, c("Station","50%","75%","90%","95","99%","99.9%","50%","75%","90%","95","99%","99.9%","50%","75%","90%","95","99%","99.9%"))
# tbl <- xtable(p)
# print(tbl,
#     only.contents=TRUE,
#     include.rownames=FALSE,
...
To investigate the frequency of extreme events, we will look at the frequency of wet hours with an intensity between 5-10, and $>$ 10 mm/hr. For more intense hourly values there is to little data.

 <<label=freqthreshold,cache=TRUE>>=
freq_5 <- hrKNMI[(RH > 5) & (RH <10)][, ':='(f = .N),by = list(Year,STN)]
freq_5 <- QR_freqall(freq_5)
freq_10 <-  hrKNMI[RH > 10][, ':='(f = .N),by = list(Year,STN)]
freq_10 <- QR_freqall(freq_10)
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    \flushleft
<<label=threshold1,cache=TRUE>>=
plot1 <- QR_freqplotting(data=freq_5[STN == 235], title="De Kooy")
plot2 <- QR_freqplotting(data=freq_5[STN == 260], title="De Bilt")
plot3 <- QR_freqplotting(data=freq_5[STN == 280], title="Eelde")
plot4 <- QR_freqplotting(data=freq_5[STN == 310], title="Vlissingen")
plot5 <- QR_freqplotting(data=freq_5[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  ...
  \begin{minipage}{0.48\textwidth}
    \flushleft
<<label=threshold2,cache=TRUE>>=
plot1 <- QR_freqplotting(data=freq_10[STN == 235], title="De Kooy")
plot2 <- QR_freqplotting(data=freq_10[STN == 260], title="De Bilt")
plot3 <- QR_freqplotting(data=freq_10[STN == 280], title="Eelde")
plot4 <- QR_freqplotting(data=freq_10[STN == 310], title="Vlissingen")
plot5 <- QR_freqplotting(data=freq_10[STN == 380], title="Maastricht")
grid.arrange(arrangeGrob(plot1, plot2, plot3, plot4, plot5, Legendgrob2, ncol=2),
             ncol= 1)
@
  ...
  \end{minipage}
  \caption{Quantile regression fits with $\tau = 25, 50, 75, 90$ \% on counts of wet hours a year, with intensity 5-10 (a) and $>$ 10 mm/hr (b), for all stations.}
  \label{QR_thres_all}
\end{figure}
...
freq_15 <-  hrKNMI[(RH > 10) & (RH <20)][, ':='(f = .N),by = Year]
...
ggplot(freq_15, aes(x = Year, color=Quantiles)) +        # data
    geom_point(aes(y=f, color="Points"))+
    geom_line(aes(y=f25, color="25%")) +
    geom_line(aes(y=f50, color="50%")) +
    geom_line(aes(y=f75, color="75%")) +
    geom_line(aes(y=f90, color="90%")) +
    scale_color_manual(values=c("Points"="gray","25%"="black", "50%"="blue" ,"75%"="green","90%"="orange")) +
...
ggplot(freq_20, aes(x = Year, color=Quantiles)) +        # data
    geom_point(aes(y=f, color="Points"))+
    geom_line(aes(y=f25, color="25%")) +
    geom_line(aes(y=f50, color="50%")) +
    geom_line(aes(y=f75, color="75%")) +
...
% Significance test
<<p_5thres,cache=TRUE>>=
p <- p_test(data=freq_5,tau=0.50,freq==TRUE)
setnames(p,c("STN","Q50_5"))
p[, ":="(Q75_5 = p_test(data=freq_5,tau=0.75,freq==TRUE)$V1,
         Q90_5 = p_test(data=freq_5,tau=0.90,freq==TRUE)$V1)]
p[, ":="(Q95_5 = p_test(data=freq_5,tau=0.95,freq==TRUE)$V1,
         Q99_5 = p_test(data=freq_5,tau=0.99,freq==TRUE)$V1,
         Q999_5 = p_test(data=freq_5,tau=0.999,freq==TRUE)$V1)]
@

<<p_10thres,cache=TRUE>>=
p[, ":="(Q50_10 = p_test(data=freq_10,tau=0.50,freq==TRUE)$V1,
         Q75_10 = p_test(data=freq_10,tau=0.75,freq==TRUE)$V1,
         Q90_10 = p_test(data=freq_10,tau=0.90,freq==TRUE)$V1)]
p[, ":="(Q95_10 = p_test(data=freq_10,tau=0.95,freq==TRUE)$V1,
...
p[, ":="(Q50_15 = p_test(data=freq_15,tau=0.50,freq==TRUE, STN=FALSE)$V1,
          Q75_15 = p_test(data=freq_15,tau=0.75,freq==TRUE, STN=FALSE)$V1,
          Q90_15 = p_test(data=freq_15,tau=0.90,freq==TRUE, STN=FALSE)$V1)]
p[, ":="(Q95_15 = p_test(data=freq_15,tau=0.95,freq==TRUE, STN=FALSE)$V1,
