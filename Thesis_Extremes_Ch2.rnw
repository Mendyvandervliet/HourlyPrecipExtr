...
p[, ":="(Q75s = p_test(data=max2d,tau=0.75)$V1, Q90s = p_test(data=max2d,tau=0.90)$V1)]
p[, ":="(Q95s = p_test(data=max2d,tau=0.95)$V1, Q99s = p_test(data=max2d,tau=0.99)$V1,
         Q999s = p_test(data=max2d,tau=0.999)$V1)]
@


<<p_test_W,cache=TRUE>>=
p[, ":="(Q50w = p_test(data=max2d,tau=0.50)$V1,Q75w = p_test(data=max2d,tau=0.75)$V1,
         Q90w = p_test(data=max2d,tau=0.90)$V1)]
p[, ":="(Q95w = p_test(data=max2d,tau=0.95)$V1, Q99w = p_test(data=max2d,tau=0.99)$V1,
         Q999w = p_test(data=max2d,tau=0.999)$V1)]
@
