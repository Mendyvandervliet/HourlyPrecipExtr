...
Implement: The reason to look at the statistics of wet events only is that these are less dependent on variations in the atmospheric circulation (Lenderink et al.,2007), which gives better statistics and enables us to better detect the influence
of atmospheric moisture on precipitation extremes. From: http://www.hydrol-earth-syst-sci.net/15/3033/2011/hess-15-3033-2011.pdf
