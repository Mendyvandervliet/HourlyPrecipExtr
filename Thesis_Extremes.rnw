...
bx1 <- bx[, list(Qm = mean(Qm), Q99 = mean(Q99), Q99.9 = mean(Q99.9)), by=Station]
@
...
<<label=intensity>>=
#,out.width='450px',fig.height=4,fig.width=9>>=
ggplot(Qt,aes(x=Station))+
  geom_boxplot(aes(y=RH))+
  geom_point(data=Qtable1,aes(y=Qm), colour='green',size=4)+
  geom_point(data=Qtable1,aes(y=Q99), colour='red',size=4)+
  geom_point(data=Qtable1,aes(y=Q99.9), colour='purple',size=3.5) +
  geom_text(data=Qtable1,aes(y=Qm,label=format(Qm,digits=2)),position=position_dodge(width=0.9),hjust=1.5,vjust=0.5)+
  geom_text(data=Qtable1,aes(y=Q99,label=format(Q99,digits=2)),position=position_dodge(width=0.9),hjust=1.5,vjust=0)+
  geom_text(data=Qtable1,aes(y=Q99.9,label=format(Q99.9,digits=2)),position=position_dodge(width=0.9),hjust=1.5,vjust=0)+
